...
begin
  ...
  begin
    ...
    begin
      ...
      if LockHandle <> nil then
      begin
        @ChangeServiceConfig2 := GetProcAddress(GetModuleHandle(advapi32), 'ChangeServiceConfig2W');
...
begin
  ...
  ServiceFailureAction.lpRebootMsg := PWideChar(RebootMessage);
  ServiceFailureAction.lpCommand := PWideChar(Command);
